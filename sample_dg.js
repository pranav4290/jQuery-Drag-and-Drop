var customUI = {
    ...
    settings : {
        ...
        saveToCookie: 'customui-dg-widget-preferences',
    ...
    init : function () {
        this.attachStylesheet('sample_dg_js.css');
        this.sortWidgets();
    ...
    addWidgetControls : function () {
        ...
        $(settings.widgetSelector, $(settings.columns)).each(function () {
            var thisWidgetSettings = customUI.getWidgetSettings(this.id);
        ...
        var customUI = this,
            ...
            $sortableItems = (function () {
                ...
                $(settings.widgetSelector,$(settings.columns)).each(function (i) {
                    if (!customUI.getWidgetSettings(this.id).movable) {
                        if(!this.id) {
